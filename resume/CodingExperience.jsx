  ...
  return (
    <>
      ...
      <List>
        ...
        <ListMarker info="Maintained and enhanced existing complex features in the platform such as shipment and carrier invoice detail pages, spreadsheet tools to input data from tables of analog/digital files, and collection of data from external sources via custom scripts. Also modernized color palette and implemented throughout the product." />
      </List>
      <Subheading
